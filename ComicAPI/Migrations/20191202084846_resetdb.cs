        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Answer_User_UserAnswerID",
            ...
            migrationBuilder.InsertData(
                table: "Answer",
                columns: new[] { "AnswerID", "AnswerTime", "Content", "PostID", "UserAnswerID" },
                values: new object[,]
                {
                    { 1, new DateTime(2019, 2, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), "Ta đề cử Tối cường thần thoại đế hoàng , Thần khống thiên hạ", null, null },
                    { 2, new DateTime(2019, 2, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), "Linh vũ thiên hạ , hộ hoa cao thủ tại đô thị , 1 truyện huyền huyễn 1 truyện đô thị", null, null },
                    { 3, new DateTime(2019, 2, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), "Sao ta không lên cấp được nhỉ?", null, null },
                    { 4, new DateTime(2019, 2, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), "chờ các cao nhân vào chỉ điểm a. chở Dâm Lão huynh đệ lên tiếng a ", null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 4, "Phong Tử Tam Tam", 0, "Cố Minh Sâm giúp Ôn Vãn, lại không ngờ con bé kia lấy oán trả ơn.Mà Ôn Vãn không thẹn với lòng, dám khẳng định: Cô đối với Cố Minh Sâm, chỉ còn kém việc, dâng cái mạng nhỏ này cho anh ta. Kết quả chỉ đổi lấy tờ giấy thỏa thuận li hôn. Quả nhiên, thế giới này vô cùng bất công, người tốt lại chẳng được đền đáp.Dùng một câu để chốt văn án: Kết thúc đoạn hôn nhân hữu danh vô thực  đáng thất vọng, vận đào hoa của Ôn Vãn bỗng nhiên khởi sắc.", 4, "https://sstruyen.com/assets/img/story//yeu-sau-nang-e-thieu-am-tham-cung-chieu-vo.jpg", 11, "Yêu Sâu Nặng", 0, new DateTime(2019, 11, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 100 },
                    { 3, "Trì Đường", 0, " Sẽ thế nào khi bạn mang trong người song tu thần kinh? Sở hữu khả năng xuyên qua 10 thế giới? Đào hoa vận không thua gì Rito (To love ru)? Lập 1 giàn harem, thủy tinh cung khủng nhất vũ trụ về khoe cho bọn bạn gato chơi.Đỗ Cầm có tất cả nhưng lại thừa 1 điều..... thừa bóng ma tâm lý về phụ nữ.Hãy đón xem công cuộc bị chinh phục của anh chàng đen đủi hay may mắn này nhé", 2, "https://sstruyen.com/assets/img/story//truyen-nhan-tru-ma-ban-trai-toi-la-cuong-thi.jpg", 11, "Truyền Nhân Trừ Ma", 1, new DateTime(2019, 11, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 100 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 7, 5, new DateTime(2019, 11, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), "truyện quá đẳng cấp :) nếu so với mấy thứ yy tự kỷ cứ như là Iphone với Bphone", 3 },
                    { 6, 11, new DateTime(2019, 11, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), "dịch rồi mà k ai convert hết @@ truyện hay mà", 3 },
                    { 3, 9, new DateTime(2019, 11, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), "Không ai dịch tiếp hả ?", 3 },
                    { 5, 7, new DateTime(2019, 11, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), "đọc đến chương 73-74 thấy tội anh Cố Yến Trinh mặc dù cùng họ với anh Cố Gia Minh nhưng die oan vãi chỉ định hù dọa anh Nghị ai ngờ họa sát thân", 2 },
                    { 2, 10, new DateTime(2019, 11, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), "Giữ tiến độ nha", 2 },
                    { 4, 11, new DateTime(2019, 11, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), "Bạo chương nha các bạn", 1 },
                    { 1, 11, new DateTime(2019, 11, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), "Truyện này hay lắm dịch giả cố lên nha", 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Mn tim giup minh cuon truyen", new DateTime(2019, 10, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "Tìm truyện sắc hiệp", 1 },
                    { 3, "Có trường hợp nào hộp thiên giới rỗng ko các đh. Ta nhận đc 1 hộp mà mở ra nó lag. Tải lại thì hộp ko còn mà vật phẩm cũng chẳng có", new DateTime(2019, 10, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "Thắc mắc hộp thiên giới", 3 },
                    { 2, "Tác phẩm các đh hay nhất từng đọc tên là gì. (Trong này có vài tác phẩm để đời ai cần ghé qua)", new DateTime(2019, 10, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "Help me", 2 },
                    { 4, "Như trên nha nhiều vợ tí nó ms thú vị ko thì nhạt bỏ mẹ ra các đạo hữu ạ", new DateTime(2019, 10, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "Xin truyện main bá đạo. Quyết đoán ( và main có nhìu vợ)", 4 }
                });
